...
#define FONT_STYLE_LEFTALIGN	DT_LEFT
#define FONT_STYLE_RIGHTALIGN	DT_RIGHT
#define FONT_STYLE_CENTERALIGN	DT_CENTER
#define FONT_STYLE_VCENTERALIGN	DT_VCENTER
#define FONT_STYLE_TOPALIGN		DT_TOP
#define FONT_STYLE_BOTTOMALIGN	DT_BOTTOM
#define FONT_STYLE_MULTILINE	DT_WORDBREAK
#define FONT_STYLE_SINGLELINE	DT_SINGLELINE
